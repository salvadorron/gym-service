...
export interface ClientRepository {
    ...
    getClientById(id: number): Promise<Prisma.ClientGetPayload<{include: { payments: true, plan: { include: { trainings: { include: { excersises: true, schedule: { include: { days: true } } } } } } }}>>
